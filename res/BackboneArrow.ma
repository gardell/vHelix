...
//Name: BackboneArrow.ma
//Last modified: Thu, May 05, 2011 02:32:02 PM
//Codeset: 1252
requires maya "2009";
requires "stereoCamera" "10.0";
currentUnit -l centimeter -a degree -t film;
fileInfo "application" "maya";
fileInfo "product" "Maya 2009";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.3814565646191144 0.72449888027139298 0.16421621327566516 ;
	setAttr ".r" -type "double3" -27.338352729650605 70.999999999978456 4.884621910830335e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 1.668546418384488;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 1.3877787807814457e-017 0 -0.29599198920118802 ;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 11.20131724656348;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".hc" -type "string" "viewSet -s %camera";
	setAttr ".o" yes;
createNode transform -n "BackboneArrow";
createNode transform -n "revolvedSurface1" -p "BackboneArrow";
	setAttr ".rp" -type "double3" 0 0 -0.29610430731422738 ;
	setAttr ".sp" -type "double3" 0 0 -0.29610430731422738 ;
createNode nurbsSurface -n "revolvedSurfaceShape1" -p "revolvedSurface1";
	...
	setAttr ".cc" -type "nurbsSurface" 
		...
		;
createNode transform -n "planarTrimmedSurface1" -p "BackboneArrow";
	setAttr ".rp" -type "double3" 0 0 -0.29610430731422738 ;
	setAttr ".sp" -type "double3" 0 0 -0.29610430731422738 ;
createNode nurbsSurface -n "planarTrimmedSurfaceShape1" -p "planarTrimmedSurface1";
	...
	setAttr ".tf[0]" -type "nurbsTrimface" no 1
		...
		1 0.1
		;
createNode transform -n "planarTrimmedSurface2" -p "BackboneArrow";
	setAttr ".rp" -type "double3" 0 0 -0.29610430731422738 ;
	setAttr ".sp" -type "double3" 0 0 -0.29610430731422738 ;
...
select -ne :defaultRenderGlobals;
	setAttr ".pram" -type "string" ";if(`whatIs mMaya_preRender` != \"Unknown\"){ eval(\"mMaya_preRender()\"); }";
	setAttr ".poam" -type "string" ";if(`whatIs mMaya_postRender` != \"Unknown\"){ eval(\"mMaya_postRender()\"); }";
